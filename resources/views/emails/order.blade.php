...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    ...
    <title>Udos - Thank you for the order</title>
    <style type="text/css">
      table {
        border-spacing: 0;
      }
                    ...
                    >
                      <tbody>
                        <tr>
                          <td>
                            <img
                              src="https://webduck.in/udos/08_ThankYou_Template_01/images/header-image.jpg"
                              style="width: 100%"
                              alt=""
                            />
                          </td>
                                ...
                                <tbody>
                                  <tr>
                                    <td
                                      ...
                                      "
                                    >
                                      <p style="font-weight: 600">$ {{$product->totalprice}}</p>
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
